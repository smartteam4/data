...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/addCourse.js"></script>
</head>
<body onload="runTime()">
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/manage/addCourse.action" id="form" method="post">
        <input type="hidden" name="CId"/>
        <table class="table table-bordered table-striped text-center">
            <tr>
                <th>课程编号<span id="s_num" class="text-right"></span></th>
                <td><input class="form-control-sm form-control-plaintext text-center"
                           required pattern="[0-9]*" maxlength="10" type="text" name="num" id="num"/></td>
            </tr>
            <tr>
                <th>课程名称<span id="s_name" class="text-right"></span></th>
            ...
            <tr>
                ...
                <td><input class="form-control-sm form-control-plaintext text-center"
                           ...
                           type="text" name="score" id="score"/></td>
            </tr>
            <tr>
                <th>任课老师<span id="s_teacher" class="text-right"></span></th>
                <td><input class="form-control-sm form-control-plaintext text-center" required
                           type="text" name="teacher" id="teacher"/></td>
            </tr>
            <tr>
