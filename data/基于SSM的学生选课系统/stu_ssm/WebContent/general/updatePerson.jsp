...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/general/updatePerson.action" id="form" method="post">
        <table class="table table-bordered table-striped text-center">
            ...
            <tr>
                ...
                <td><input class="form-control-sm form-control-plaintext text-center" type="text"
                           required pattern="1[3|4|5|7|8|9][0-9]\d{8}" maxlength="11"
                           name="phone" id="phone" value="${user.UPhone}"/></td>
            </tr>
            <tr>
